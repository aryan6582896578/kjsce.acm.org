...
const Navbar = () => {
    ...
    const handleScrollTo = (id) => {
        ...
        setIsMenuOpen(false); // Close the menu on selecting an item
    };

    return (
        <>
            <nav className="z-[999] flex justify-center items-center fixed top-0 left-0 right-0">
                <div className="z-20 h-[65px] w-auto max-w-[800px] min-w-[50vw] backdrop-filter backdrop-blur-md bg-[rgba(255, 255, 255, 0.2)] border-2 border-solid shadow-2xl border-white border-opacity-10 rounded-xl flex justify-between items-center mt-7">
                    {/* Logo */}
                    <div className="image">
                        <img
                            className="h-32 m-5 cursor-pointer"
                ...
                {/* Fullscreen Drawer */}
                <div
                    className={`fixed inset-0 bg-[rgba(255, 255, 255, 0.9)] backdrop-blur-md z-[1000] transform transition-transform duration-300 ease-in-out ${
