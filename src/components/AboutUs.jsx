function AboutUs() {
  return (
    <div className='flex flex-col justify-center items-center bg-gradient-to-b from-indigo-950 via-cyan-900  to-cyan-400  p-8 mt-28 bg-opacity-90'>
        <h1 className='text-4xl uppercase font-black dark:text-white text-black px-8 mb-4 md:mb-8 border-t-cyan-400 border-t-2'>About Us</h1>
        <div className='flex flex-col md:flex-row justify-center md:items-center mb-16 w-full h-1/2'>
          <div className='flex flex-col justify-center items-center md:w-1/2 w-full'>     
            <div className='md:text-6xl text-3xl text-center dark:text-white text-black mb-4 md:mb-0 md:mr-8 font-bold md:pb-4'>
...
At KJSCE ACM, our mantra is simple: together we strive, together we achieve..... and maybe have a little too much fun along the way!
        ...
        <div className='relative flex justify-center'>
            <div className='absolute inset-0 transform  -translate-x-1/12 md:translate-x-1/3 -translate-y-4 bg-gradient-to-r from-purple-500 to-pink-500 md:w-2/3 w-11/12 rounded-2xl'></div>
